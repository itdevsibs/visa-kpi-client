...
const AppShell = ({ children }) => {
  ...
  const {
    ...
    selectedSimUserEmail, setSelectedSimUserEmail,
    selectedSimTeam, setSelectedSimTeam,
    employees,
    activeEmployeeUsers
  } = useRoster();
  ...
  return (
    <div className="flex h-screen w-full bg-slate-50 text-slate-900 font-sans overflow-hidden">
      ...
      <main className="flex-1 flex flex-col min-w-0 bg-slate-50 overflow-hidden">
        ...
        {/* Page Content */}
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 thin-scroll relative">
